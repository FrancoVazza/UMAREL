  ...
  tag="test"    #....will be attached to all output file names to differentiate them if necessary 
  np = 20000   #...total number of UHECR     
    ...
    #..PATH TO FOLDERS OF ROUTINES AND FILES
      ...
      include(string(main,"UMAREL_parameters.jl"))
      include(string(main,"UMAREL_functions.jl"))   #...external module with all relevant functions used for the transport of CRs    
